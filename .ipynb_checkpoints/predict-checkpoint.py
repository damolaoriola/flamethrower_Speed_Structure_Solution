...
Author: Damola Oriola(flamethrower)
"""
...
def load_all_folds_models(args):
    ...
    for fold in range(args.num_folds):
        if fold in [1, 2, 3, 4]:
            folds_models.append([
                create_eva_model(args, 'Multi_Split_10_MHA_4_heads', fold),
                create_eva_model(args, 'Split_10_MHA_2_heads', fold),
                create_eva_model(args, 'Single_Split_10_MHA_4_heads', fold),
            ])
        elif fold == 0:
            folds_models.append([
                create_eva_model(args, 'Multi_Split_10_MHA_4_heads', fold),
                create_eva_model(args, 'Split_9_MHA_4_heads', fold),
                create_eva_model(args, 'Single_Split_10_MHA_4_heads', fold),
            ])
